# Generated by Powerlevel10k configuration wizard on 2023-08-25 at 13:18 -03.
...
# blurred heads, flat tails, 2 lines, solid, full frame, sparse, fluent,
...
() {
  ...
  # Custom prefix.
  #typeset -g POWERLEVEL9K_KUBECONTEXT_PREFIX'="%246L at"
  ...
  function instant_prompt_customer() {
        prompt_customer
  }
  function prompt_customer() {
    p10k segment -f 33 -i '' -t "$CUSTOMER"
  }

  function instant_prompt_tailscale(){
    prompt_tailscale
  }

  function prompt_tailscale(){
    tailscale status > /dev/null
    [ $? = 0 ] && color=2 || color=196

    p10k segment -f $color -i '' -t "TAILSCALE"
  }
